...
impl<'a> AttributeValue for &'a str {
    type State = (types::Element, &'a str);
...
impl<'a> AttributeValue for &'a String {
    type AsyncOutput = Self;
    type State = (types::Element, &'a String);
    type Cloneable = Self;
    type CloneableOwned = Arc<str>;
...
impl AttributeValue for String {
    type AsyncOutput = Self;
    type State = (types::Element, String);
...
impl AttributeValue for Arc<str> {
    type AsyncOutput = Self;
    type State = (types::Element, Arc<str>);
    type Cloneable = Arc<str>;
    type CloneableOwned = Arc<str>;
    ...
    V: AttributeValue,
{
    ...
    type State = (types::Element, Option<V::State>);
  ...
  ($($child_type:ty),* $(,)?) => {
      $(
...

        {
            ...
            type State = (types::Element, $child_type);
            type Cloneable = Self;
            type CloneableOwned = Self;
