...
use crate::_tachys::html::attribute::Attribute;
...
macro_rules! no_attrs {
    ($ty_name:ty) => {
        impl<'a> $crate::_tachys::view::add_attr::AddAnyAttr for $ty_name {
            type Output<SomeNewAttr: $crate::_tachys::html::attribute::Attribute> = $ty_name;

            fn add_any_attr<NewAttr: $crate::_tachys::html::attribute::Attribute>(
                self,
                _attr: NewAttr,
            ) -> Self::Output<NewAttr> {
                self
